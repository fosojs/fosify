...
function bundleScripts(opts, cb) {
  ...
  var rootIndexRegex = RegExp(opts.source + '/fosofile\.(js|es6|babel)');
  var createPath = pathCreator.js(opts.source);
  ...
  glob(opts.source + '{/*/**/bundle,/**/*.bundle,/fosofile}.{js,es6,babel}', function(err, files) {
